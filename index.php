...
<head>
    ...
    <script>
        ...
        (function() {
            ...
            hm.src = "https://hm.baidu.com/hm.js?c72c001b5570d5a16f47efc7dd275df9";
...
<body>
    ...
    <div class="list closed">
        <ul>
            ...
            <li><a rel="nofollow" href="https://blog.lerogo.com/fun_api.html" target="_blank"><i class="iconfont icon-wangluo" style="color:#02f"></i>站长api</a></li>
            ...
            <li><a rel="nofollow" href="https://blog.lerogo.com/分享资源.html" target="_blank"><i class="iconfont icon-baiduyun" style="color:#148bfe"></i>站长分享</a></li>
            ...
            <li><a rel="nofollow" href="https://other.lerogo.com/tools/music/" target="_blank"><i class="iconfont icon-yinle" style="color:#f4a"></i>音乐解析</a></li>
    ...
    <div id="content">
        <div class="con">
            ...
            <div class="sou">
                <form action="" method="post" target="_self"><input class="t" type="text" value="0" name="t" hidden> <input class="wd" type="text" placeholder="请输入搜索内容" name="q" x-webkit-speech lang="zh-CN"> <button><i style="font-size:20px" class="iconfont icon-sousuo"></i></button></form>
                <ul>
                    <li data-s="baidu" target="_blank"><i style="background-image:url(icon/baidu.svg)"></i>百度一下</li>
                    <li data-s="bing" target="_blank"><i style="background-image:url(icon/bing.svg)"></i>Bing国际</li>
        ...
        <div class="foot">
            © <?php echo date("Y") ?>
            <a href="https://blog.lerogo.com/">lerogo</a>.
            <a target="_blank" href="https://pay.lerogo.com/">donate</a>
            <p>
